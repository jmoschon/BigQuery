select a.countries.country as country,
       a.area_id.area_id as city_id, 
       a.vendor_visits.device.operatingsystem as operatingsystem,
       a.vendor_visits.vendor_id as vendor_id,
       '' as vendor_code,
       a.vendor_visits.date as date,
       'APP' as platform,
       a.vendor_visits.channel as medium,
       '' as landingpage,
...
(select area_id.area_id, area_id.city_id, vendor_visits.date ,vendor_visits.vendor_id, countries.country,vendor_visits.device.operatingSystem, vendor_visits.Users, vendor_visits.channel, sum(vendor_visit) visits from
      (
        select a.*
        from
            flatten (
