select ak.country, platform,deviceCategory,FIRST(split(NTH(2,SPLIT(ak.payment,'55=')),';113')) as payment,
...
--      REGEXP_EXTRACT(ak.payment,'55=') as second_part,
    ...
    select date,
            ...
            , TABLE_DATE_RANGE([74762698.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -3, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY'))
            , TABLE_DATE_RANGE([108855442.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -3, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY'))
