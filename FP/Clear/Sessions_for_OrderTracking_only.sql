...
--          on a.fullVisitorId=c.fullVisitorId and a.visitId=c.visitId and c.date=b.date
      ...
      group by 1,2,3,4,5,6,7,8)as web
...
select b.country as country,
       ...
       b.date as date,
       a.Users as Users,
       a.device.operatingSystem as operatingSystem,
      ...
      (
       select date,
          ...
          from TABLE_DATE_RANGE([74773001.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -30, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY')),TABLE_DATE_RANGE([74762698.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -30, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY')), TABLE_DATE_RANGE([108855442.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -30, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY'))

           group each by 1,3,2,4,5,6
     )a
     ...
     join each
       ...
       select date,
          ...
          group by 1,2,3,4,5,6,7,8) as app
