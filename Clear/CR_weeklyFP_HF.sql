...
from
  (select date,
    ...
    from TABLE_DATE_RANGE([86553600.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -10, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY'))
    --, TABLE_DATE_RANGE([87584217.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -10, 'DAY')
    --, DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY')), TABLE_DATE_RANGE([108857524.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -10, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY'))
        ...
        from
            flatten (
                      (
                       ...
                       from TABLE_DATE_RANGE([86553600.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -10, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY'))
                       --, TABLE_DATE_RANGE([87584217.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -10, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY')), TABLE_DATE_RANGE([108857524.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -10, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY'))
                       where hits.customDimensions.index=3 and (hits.customDimensions.value='IN' or hits.customDimensions.value='HK' or hits.customDimensions.value='SG')
...
from TABLE_DATE_RANGE([86553600.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -10, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY'))
--,TABLE_DATE_RANGE([87584217.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -10, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY'))
...
--       from TABLE_DATE_RANGE([74773001.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -10, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY')), TABLE_DATE_RANGE([74762698.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -10, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY')), TABLE_DATE_RANGE([108855442.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -10, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY'))
...
--          from TABLE_DATE_RANGE([74773001.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -10, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY'))
--          --, TABLE_DATE_RANGE([74762698.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -10, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY')), TABLE_DATE_RANGE([108855442.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -10, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY'))
...
--                        from TABLE_DATE_RANGE([74773001.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -10, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY'))
--                        --, TABLE_DATE_RANGE([74762698.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -10, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY')), TABLE_DATE_RANGE([108855442.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -10, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY'))
--                        where hits.customDimensions.index=1 and hits.customDimensions.value='MY'
...
--(select fullVisitorId, unique (visitId) as visitid, regexp_extract(hits.customDimensions.value,r'([^_]*)') as city_id, regexp_extract(hits.customDimensions.value,r'_(.*)') as area_id
--from TABLE_DATE_RANGE([74773001.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -10, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY'))
----, TABLE_DATE_RANGE([74762698.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -10, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY'))
