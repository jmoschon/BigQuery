  ...
  from
    (select date,
      ...
      from TABLE_DATE_RANGE([86553600.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -150, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY')), TABLE_DATE_RANGE([87584217.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -150, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY')), TABLE_DATE_RANGE([108857524.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -150, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY'))
  ...
  from TABLE_DATE_RANGE([86553600.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -150, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY')),TABLE_DATE_RANGE([87584217.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -150, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY'))
  ...
  group each by 1,2,3,4,5,6,7,8,9) as web
  ...
  /* assigning 1 or 0 for each funnel step for every session */
    from
       ...
       ( select date,
         ...
         from TABLE_DATE_RANGE([74773001.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -300, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY'))
              ...
              flatten (
                        (
                          ...
                          from TABLE_DATE_RANGE([74773001.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -300, 'DAY'), DATE_ADD(CURRENT_TIMESTAMP(), -2, 'DAY'))
                                                  ...
                                                  where hits.customDimensions.index=1 and hits.customDimensions.value='SG' or hits.customDimensions.value='IN' or hits.customDimensions.value='HK'
