# mCVR shop.list > details
# Get the landing page and check only the sessions where there are at least shope_list.loaded and shop_details.loaded. check how many of them are directly going from shop list to shop details
