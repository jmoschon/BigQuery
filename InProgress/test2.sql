select a.fullvisitorid, a.visitid, sum(a.sessions), sum(b.sessions), sum(d.sessions) from (
...
--              case when visitnumber=1 then "New Visitors" else "Returning Visitors" end as Users,
        ...
        from TABLE_DATE_RANGE([74773001.ga_sessions_], DATE_ADD(CURRENT_TIMESTAMP(), -4, 'DAY')
